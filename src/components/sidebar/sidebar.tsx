      ...
      >
        <div className="flex h-16 items-center justify-center bg-gray-900">
          <button className="justify-start px-3 py-5" onClick={toggleSidebar}>
            <FaBars className={`size-4 ${isHidden ? "text-gray-300" : "text-white"}`} />
          </button>
          <div className={`duration-5000 flex flex-1 justify-center transition-opacity ${isHidden ? "hidden" : "block"}`}>
        ...
        <div className="flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
          <nav className="flex-1 bg-gray-800">
            <Sidebarparentcomponent
              ...
              text="Dashboard"
            />
            <Sidebarparentcomponent icon={<FaBell />} isHidden={isHidden} link="/about" text="About" />
            <Sidebarparentcomponent icon={<FaScrewdriver />} isHidden={isHidden} link="/blog" text="blog" />
